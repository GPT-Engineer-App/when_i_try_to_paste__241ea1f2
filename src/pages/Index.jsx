...
const Index = () => {
  ...
  const validateBackgroundImage = (url) => {
    const pattern = /^(https?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?$/;
    if (!pattern.test(url)) {
      setBackgroundImageError("Please enter a valid URL");
      return false;
    }
          ...
          <Box flex="1" bg="gray.100" p={4}>
            <Box flex="1" bg="gray.100" p={4}>
                    ...
                    <FormControl>
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          validateBackgroundImage(e.target.value);
                        }}
                      />
                      {backgroundImageError && <Text color="red.500">{backgroundImageError}</Text>}
                    </FormControl>
                    <Button colorScheme="blackAlpha" onClick={() => {}} mt={4}>
                      Apply Background
                    </Button>
              ...
              <Flex h="20%" alignItems="center" justifyContent="space-between" p={4} borderTopWidth="1px">
                <Button onClick={prevStep} isDisabled={activeStep === 1}>
                  Previous
                </Button>
          ...
          <DrawerContent>
            ...
            <DrawerBody>
              <VStack spacing={4} alignItems="flex-start">
                <Text>Designed by Deon Tran, known for creating robust and user experience (UX) focused applications.</Text>
                <Text>
                  Check out more of his work at{" "}
                  <a href="https://deonneon.netlify.app" isExternal style={{ textDecoration: "underline", color: "blue.500", _hover: { color: "blue.600" } }}>
                    deonneon.netlify.app
                  </a>
                  . You can also navigate the below screen.
                </Text>
                <iframe title="Deon Tran's Portfolio" src="https://deonneon.netlify.app" width="100%" height="300px" style={{ border: "none" }} />
              </VStack>
            </DrawerBody>
          </DrawerContent>
        </Drawer>
